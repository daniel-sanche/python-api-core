...
from google.api_core._cross_sync._decorators import AstDecorator, ConvertClass
...
class CrossSyncFileProcessor(ast.NodeTransformer):
    ...
    def visit_Module(self, node):
        ...
        if output_path:
            ...
            # strip out top-level module docstring
            if isinstance(converted.body[0], ast.Expr) and isinstance(converted.body[0].value, ast.Str):
                converted.body.pop(0)
            return converted
        else:
